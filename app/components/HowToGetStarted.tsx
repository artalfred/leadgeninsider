        ...
        <div className="grid">
          <div className="grid justify-center items-center grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 2xl:grid-cols-1 gap-5">
            <div className="grid 2xl:gap-10 md:gap-7 sm:gap-7 gap-7">
              <div className="grid gap-4 bg-amber-50/10 rounded-2xl w-full 2xl:px-30 md:px-15 sm:px-4 px-4 py-14">
                <div
...
"
                ...
                <div className="">
                  <h1 className="text-white leading-normal font-bold 2xl:text-4xl lg:text-4xl md:text-3xl sm:text-3xl text-3xl">
