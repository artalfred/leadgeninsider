    ...
    <div className="max-w-7xl mx-auto 2xl:py-20 2xl:px-0 md:px-4 sm:px-4 px-4 2xl:mt-30 mt-40 grid gap-10">
      ...
      <div className="grid justify-between items-center grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 2xl:grid-cols-2 gap-5">
        <div className="bg-[#0F172A] rounded-2xl p-6 shadow-lg">
          <div className="grid gap-2 items-center">
            ...
            <p className="text-gray-400">
              Stop wasting weeks on manual technical setup and start sending at
              scale. This <span className="font-bold">done-for-you</span>{" "}
          ...
          <div className="grid gap-4 mt-6 ">
            <ul className="grid gap-1">
              ...
              <li className="text-md gap-3 text-gray-300">
                ...
                <span className="font-bold">Automated subdomain creation </span>
                under one main domain
              </li>
              <li className="text-md gap-3 text-gray-300">
                <span className="mr-4">✔</span>
                <span className="font-bold">Automated DNS configuration </span>
        ...
        <div className="bg-[#0F172A] rounded-2xl p-6 shadow-lg">
          ...
          <h1 className="mt-6 text-lg font-medium text-white">
            Core Features:{" "}
          </h1>
