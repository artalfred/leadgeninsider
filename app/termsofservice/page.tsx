      ...
      <div className="rounded-2xl pt-2 px-8 bg-slate-600/20 w-fit mt-10">
        ...
        <div className="grid gap-2 py-6 border-b-2 border-b-gray-500">
          ...
          <ul className="m-6 grid gap-4">
            ...
            <li className="list-disc">Inbox setup and scaling strategies.</li>
            <li className="list-disc">
              Monthly inbox management and reputation monitoring.
            </li>
            <li className="list-disc">Web development (WordPress/Framer).</li>
            <li className="list-disc">Managed campaign partnerships.</li>
          </ul>
        </div>
        <div className="grid gap-2 py-6 border-b-2 border-b-gray-500">
          <h1 className="mt-2 2xl:text-xl md:text-xl sm:text-lg text-lg text-start 2xl:w-240 md:w-full w-full font-bold">
          ...
          <p>To ensure a successful setup, clients agree to:</p>
        ...
        <div className="grid gap-2 py-6 border-b-2 border-b-gray-500">
          ...
          <ul className="m-6 grid gap-4">
            ...
            <li className="list-disc">
              <span className="text-green-500 font-bold">Refunds: &nbsp;</span>
        ...
        <div className="grid gap-2 py-6">
          ...
          <ul className="m-6 grid gap-4">
            ...
            <li className="list-disc">
              <span className="text-green-500">Phone:</span> +63 967 134 8488
            </li>
          </ul>
        </div>
      </div>
